...
public class ModifierProvider extends AbstractModifierProvider implements IConditionBuilder {
  ...
  protected void addModifiers() {
    ...
    buildModifier(ModifierIds.reach)
      ...
      .addModule(AttributeModule.builder(Attributes.ATTACK_DAMAGE, Operation.ADDITION).uniqueFrom(ModifierIds.reach).eachLevel(1));
    ...
    buildModifier(ModifierIds.fireProtection)
      ...
      .addModule(ProtectionModule.builder().sources(DamageSourcePredicate.CAN_PROTECT).tags(DamageTypeTags.IS_FIRE).eachLevel(2.5f));
    ...
    buildModifier(ModifierIds.featherFalling).addModule(ProtectionModule.builder().tags(DamageTypeTags.IS_FALL).eachLevel(3.75f));
    buildModifier(ModifierIds.longFall)
      ...
      .addModule(BlockDamageSourceModule.source(DamageTypeTags.IS_FALL).build());
    buildModifier(ModifierIds.frostWalker)
      .levelDisplay(ModifierLevelDisplay.NO_LEVELS)
      .addModule(BlockDamageSourceModule.source(new SourceMessagePredicate((Minecraft.getInstance().level).damageSources().hotFloor())).build())
