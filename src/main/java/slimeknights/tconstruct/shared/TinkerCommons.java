...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final ItemObject<Block> obsidianPane = BLOCKS.register("obsidian_pane", () -> new BetterPaneBlock(builder(Blocks.STONE, MapColor.PODZOL, SoundType.STONE).requiresCorrectToolForDrops().noOcclusion().strength(25.0F, 400.0F)), GENERAL_BLOCK_ITEM);
  // platforms
   ...
   * Items
   */
  public static final ItemObject<EdibleItem> bacon = ITEMS.register("bacon", () -> addToTabItemList(new EdibleItem(TinkerFood.BACON), TAB_GENERAL_ITEMS));
  public static final ItemObject<EdibleItem> jeweledApple = ITEMS.register("jeweled_apple", () -> addToTabItemList(new EdibleItem(TinkerFood.JEWELED_APPLE), TAB_GENERAL_ITEMS));
  public static final ItemObject<Item> cheeseIngot = ITEMS.register("cheese_ingot", () -> addToTabItemList(new CheeseItem(new Properties().food(TinkerFood.CHEESE)), TAB_GENERAL_ITEMS));
  public static final ItemObject<Block> cheeseBlock = BLOCKS.register("cheese_block", () -> addToTabItemList(new HalfTransparentBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).strength(1.5F, 3.0F).speedFactor(0.4F).jumpFactor(0.5F).sound(SoundType.HONEY_BLOCK).noOcclusion()), TAB_GENERAL_ITEMS), block -> new CheeseBlockItem(block, new Properties().food(TinkerFood.CHEESE)));
