 ...
 */
public record ConditionalAOEIterator(IJsonPredicate<BlockState> condition, AreaOfEffectIterator.Loadable ifTrue,
                                     AreaOfEffectIterator.Loadable ifFalse) implements AreaOfEffectIterator.Loadable {
